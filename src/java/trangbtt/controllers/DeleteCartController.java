...
public class DeleteCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            //giỏ hàng là thuộc tính của session
           ...
           // int id= Integer.parseInt(request.getParameter("id")) ;
            ...
            shoppingCart.removeCart(ct -1);
            session.setAttribute("cart", shoppingCart);// không có vẫn chạy, đây là dòng lý thuyết , tương tác giỏ hàng phải cập nhật sesion lại
            //trong java nó tự gọi lại session
        } catch (Exception e) {
