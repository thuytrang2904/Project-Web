<%-- 
    Document   : index
    Created on : Nov 27, 2019, 8:21:54 PM
    Author     : ASUS
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./css/signInT2.css" type="text/css">
    </head>
    <body class="align">

        <div class="grid">

            <form  action="SignInController" method="POST" class="form login">
                <%
                    RegistrationErrorObject errObj = (RegistrationErrorObject) request.getAttribute("INVALID");
                %>
                <div class="form__field">
                    <label for="login__username"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Username</span></label>
                    <input id="login__username"class="form__input" type="text" name="txtPhone" value="${param.txtPhone}" placeholder="Phone" required/>
                ...
                <div class="form__field">
                    ...
                    <input id="login__password" type="password" class="form__input" name="txtPassword" placeholder="Password"required />
